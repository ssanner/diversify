...
\subfour{\bf Portfolio Theory:} \cite{wang09PortfolioTheory} motivates
...
\subfour{\bf Subtopic Relevance Models:} We use a subtopic relevance
...
\subfour{\bf Set-based Relevance Objectives:} Chen and
...
\subfour{\bf Ranking Based Objectives:} Finally, returning to our
